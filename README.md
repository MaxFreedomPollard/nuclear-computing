...
| ¹⁸⁰ᵐTa (75.3 keV, stable) | leak trivially beaten | ≈ 1, and energy uphill | trigger proven (photoactivation, 1999); an amplifier never |
...
- **Level restoration.** Driven through the water from A, by ²⁵²Cf at its own axis, or by a 14.1 MeV line, tank B emits the same fission spectrum to a total variation distance of 0.002. Inputs spanning thermal to 14 MeV, one output: the self restoring class of the theory supplement, measured. The photon sector cannot buy this at any price, because an isomer cascade emits its own lines and not its trigger's.
...
| ¹⁸⁰ᵐTa | 75.3 keV | stable | 0 | ≈ 1 | 0.075 | proof that photon triggering is real; energy uphill | photoactivation proven (1999) |
