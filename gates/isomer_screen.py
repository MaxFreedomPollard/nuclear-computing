...
CANDIDATES = [
    ...
    dict(key="180mTa", livechart=None, E_keV=75.3,
    ...
    dict(key="137mBa", livechart="137ba", E_keV=661.66,
         ...
         beta_gamma=None, mech="readout reference (¹³⁷Cs generator)",
    ...
    dict(key="99mTc", livechart="99tc", E_keV=142.68,
         ...
         beta_gamma=None, mech="availability reference (⁹⁹Mo generator)",
...
def make_figure(isomers):
    ...
    marks = [
        ...
        ("¹⁸⁰ᵐTa", STABLE_X, 75.3, GREEN, "photodepletion proven"),
