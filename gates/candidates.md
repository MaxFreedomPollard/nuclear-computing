| state | E stored | t1/2 | lambda_m (1/s) | beta (gamma/release) | trigger mechanism | E trigger | leverage | status |
|---|---|---|---|---|---|---|---|---|
| 229mTh | 0.00835573 keV | 29 min | 3.98e-04 | 1 | resonant VUV laser (stimulated pump/dump) | 0.008356 keV | 1 | PROVEN trigger (laser, 2024) |
