...
axB.text(10.5, 20.5, "amplifying gate  $\\Gamma>1$", color=GREEN, fontsize=9.5, fontweight="bold")
...
axB.scatter([14], [14*0.5], color=RED, zorder=5, s=70)
axB.annotate("$^{178m2}$Hf\n($\\beta\\!\\sim\\!12$ photon cascade,\n2.4 MeV stored — unproven trigger)",
             xy=(14, 7), xytext=(15, 14), fontsize=8, color=RED,
...
comp = [
    ...
    ("Coincidence AND (γ–γ)", 9.8, 8.0, GREEN, -3.6, 0.1),
    ("Absorption NOT / scattering MUX", 9.0, 5.2, GREEN, -4.7, -0.45),
    ("Th-229 isomer memory (laser R/W)", 6.8, 7.0, BLUE, -4.0, 0.35),
